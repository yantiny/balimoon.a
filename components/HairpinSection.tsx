...
export default function HairpinSection() {
  const products = [
    {
      name: "Sakura Clip",
      price: "Rp 15.000",
      image: "/hairpin/sakura.jpg",
    },
    {
      name: "Pastel Flower",
      price: "Rp 6.000",
      image: "/hairpin/pastel.jpg",
    },
    {
      name: "Cherry clip",
      price: "Rp 7.000",
      image: "/hairpin/cherry.jpg",
    },
    {
      name: "Red Butterfly",
      price: "Rp 7.000",
      image: "/hairpin/butterfly.jpg",
    },
  ];
  ...
  return (
    <section className="px-4 sm:px-10 md:px-20 py-6 md:py-10">
      ...
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Hairpin</h2>
